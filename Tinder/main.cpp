...
int main()
{
	...
	bool z;
	string hair, name, surname, zodiac_sign, town, hair_f, zodiac_sign_f, town_f, inter;
	vector <string> interest;
	string age_1, tmp_2;
	int age, age_f, age_f2, q;

	cout << "\n\tДобро пожаловать в TINDER!!!" << endl << "\tВыберите кого хотите найти\n" << endl;
	system("pause");
	system("cls");
			...
			case 13:
				...
				if (active_menu == 0)
				{
					do
					{
						...
						cout << "Введите цвет ваших волос (блондин, брюнет) - ";	cin >> hair;
						transform(hair.begin(), hair.end(), hair.begin(), tolower);
						do
						{
						...
						cout << "Введите цвет волос - ";	cin >> hair_f;
						transform(hair_f.begin(), hair_f.end(), hair_f.begin(), tolower);
					...
					system("cls");
					Tinder tin(hair, name, surname, age, zodiac_sign, town, hair_f, zodiac_sign_f, town_f, age_f, age_f2, interest, 0);
					tin.Print();
					cout << "*********************************************************" << endl;
					system("pause");
					system("cls");
				...
				else if (active_menu == 1)
				{
					...
					do
					{
						cout << "Введите ваше имя - ";	cin >> name;
						cout << "Введите вашу фамилию - ";	cin >> surname;
						cout << "Введите цвет ваших волос (блондинка, брюнетка) - ";	cin >> hair;
						transform(hair.begin(), hair.end(), hair.begin(), tolower);
						do
						{
							cout << "Введите ваш возраст - "; cin >> age_1;
